const tickets = [
  ...
  },
  {
    ...
    description: "Customer tries to upload a new profile picture but gets 'Upload failed' error every time.",
  ...
  },
  {
    ...
    description: 'Customer wants to enable auto-renewal for their subscription but the toggle is disabled and unresponsive.',
  ...
  },
  {
    ...
    description: 'Customer got locked out after three failed login attempts and the unlock email never arrived.',
    customer: 'Noah White',
    priority: 'high',
    status: 'open',
    createdAt: '1/25/2024',
  },
  {
    ...
    description: 'Customer ordered a blue jacket but received a red one. Requesting exchange or full refund.',
    customer: 'Ava Harris',
    priority: 'high',
    status: 'open',
    createdAt: '1/26/2024',
